...
public class Dongmu_Search extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.addItem(new Dongmu_Search_LIstItem(R.drawable.dongmu_food_ex01, R.drawable.dongmu_icon_tag01, R.drawable.dongmu_icon_tag02, R.drawable.dongmu_icon_tag03, R.drawable.dongmu_icon_tag04, "맛집", "35M", "더차이나", "#맛있음", "#그럭저럭", "짱깨", "#짱꼴라"));
        ...
        adapter.addItem(new Dongmu_Search_LIstItem(R.drawable.dongmu_food_ex01, R.drawable.dongmu_icon_tag01, R.drawable.dongmu_icon_tag02, R.drawable.dongmu_icon_tag03, R.drawable.dongmu_icon_tag04, "술집", "1.2KM", "포차천국", "#4차", "#까지", "#준비되어", "#있어"));
        adapter.addItem(new Dongmu_Search_LIstItem(R.drawable.dongmu_food_ex01, R.drawable.dongmu_icon_tag01, R.drawable.dongmu_icon_tag02, R.drawable.dongmu_icon_tag03, R.drawable.dongmu_icon_tag04, "술집", "400M", "비어킹", "#맨날", "#가는데도", "#안질리냐", "#팍씨"));
        adapter.addItem(new Dongmu_Search_LIstItem(R.drawable.dongmu_food_ex01, R.drawable.dongmu_icon_tag01, R.drawable.dongmu_icon_tag02, R.drawable.dongmu_icon_tag03, R.drawable.dongmu_icon_tag04, "식당", "70M", "대두순두부", "#나는", "#맛있던데", "#왜", "#아무도 안가지"));
        adapter.addItem(new Dongmu_Search_LIstItem(R.drawable.dongmu_food_ex01, R.drawable.dongmu_icon_tag01, R.drawable.dongmu_icon_tag02, R.drawable.dongmu_icon_tag03, R.drawable.dongmu_icon_tag04, "맛집", "35M", "더차이나", "#맛있음", "#그럭저럭", "짱깨", "#짱꼴라"));
        adapter.addItem(new Dongmu_Search_LIstItem(R.drawable.dongmu_food_ex01, R.drawable.dongmu_icon_tag01, R.drawable.dongmu_icon_tag02, R.drawable.dongmu_icon_tag03, R.drawable.dongmu_icon_tag04, "갈비집", "140M", "가산 북촌삼대갈비", "#생갈비의", "#맛을", "#느껴", "#보아라"));
    ...
    class DongmuSearchAdapter extends BaseAdapter {
        ArrayList<Dongmu_Search_LIstItem> items = new ArrayList<>();
        ...
        public void addItem(Dongmu_Search_LIstItem item) {
            items.add(item);
        }
        ...
        public View getView(int position, View convertView, ViewGroup viewGroup) {
            Dongmu_Search_List view = new Dongmu_Search_List(getApplicationContext());

            Dongmu_Search_LIstItem item = items.get(position);
