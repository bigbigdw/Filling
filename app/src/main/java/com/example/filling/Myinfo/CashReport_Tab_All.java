...
public class CashReport_Tab_All extends Fragment {

    ListView listView;
    CashReport_Tab_All.SingerAdapter adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        adapter = new CashReport_Tab_All.SingerAdapter();
        ...
        adapter.addItem(new CashReport_ListItem("Cash충전", "20.07.16", "+ 12", "12,332",R.drawable.icon_report_plus));
        adapter.addItem(new CashReport_ListItem("Cash선물 전송", "20.07.14", "+ 53", "12,279",R.drawable.icon_report_plus));
        adapter.addItem(new CashReport_ListItem("Cash결제", "20.07.02", "- 25", "12,304",R.drawable.icon_report_minus));
        adapter.addItem(new CashReport_ListItem("Cash결제", "20.06.27", "- 17", "12,321",R.drawable.icon_report_minus));
        adapter.addItem(new CashReport_ListItem("Cash결제", "20.06.06", "- 12", "12,333",R.drawable.icon_report_minus));
        adapter.addItem(new CashReport_ListItem("Cash충전", "20.05.17", "+ 53", "12,280",R.drawable.icon_report_plus));
        adapter.addItem(new CashReport_ListItem("Cash충전", "20.04.06", "+ 17", "12,263",R.drawable.icon_report_plus));
        adapter.addItem(new CashReport_ListItem("Cash결제", "20.03.30", "- 26", "12,289",R.drawable.icon_report_minus));
        adapter.addItem(new CashReport_ListItem("Cash선물 수령", "20.03.10", "+ 56", "12,233",R.drawable.icon_report_plus));
        adapter.addItem(new CashReport_ListItem("Cash선물 수령", "20.03.06", "+ 41", "12,192",R.drawable.icon_report_plus));
        adapter.addItem(new CashReport_ListItem("Cash결제", "20.02.15", "- 32", "12,224",R.drawable.icon_report_minus));
        adapter.addItem(new CashReport_ListItem("Cash선물 전송", "20.02.02", "- 50", "12,274",R.drawable.icon_report_minus));
